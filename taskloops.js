...
for (i=0; i<countries.length; i++){
   if (countries[i].population >= 0 && countries[i].population <=50_000_000){
        pops["0-50m"]++
   }
   else if( countries[i].population >= 51_000_000 && countries[i].population <= 100_000_000){
        pops["51-100m"]++
   }
   else{
        pops[">100m"]++
...
console.log(pops) //{0-50m: 215, 51-100m: 16, >100m: 13}
